...
public class PostAdminController {
    ...
    public String showDashboard(Model model, @RequestParam(name = "page", defaultValue = "1") int page) {
        ...
        PaginationInfo paginationInfo = new PaginationInfo(publishedPosts);
    ...
    @RequestMapping(path = "/{postID:\\d+}{slug}", method = {POST})
    ...
    @RequestMapping(path = "/{postID:\\d+}{slug}", method = {POST}, params = "_action=DELETE")
